...
class Players(db.Model):
    ...
    tot_points = db.Column('tot_points', db.Integer)
    tot_rebounds = db.Column('tot_rebounds', db.Integer)
    tot_assists = db.Column('tot_assists', db.Integer)
    tot_steals = db.Column('tot_steals', db.Integer)
    tot_blocks = db.Column('tot_blocks', db.Integer)
    tot_turnovers = db.Column('tot_turnovers', db.Integer)
    tot_fgm = db.Column('tot_fgm', db.Integer)
    tot_fga = db.Column('tot_fga', db.Integer)
    tot_ftm = db.Column('tot_ftm', db.Integer)
    tot_fta = db.Column('tot_fta', db.Integer)
